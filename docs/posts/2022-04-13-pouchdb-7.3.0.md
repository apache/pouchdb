...
* [ac7bcc65](https://github.com/pouchdb/pouchdb/commit/ac7bcc6532700071178fed3d0416c38058133477) Do not run eslint afterAll tests, but make it a distinct task that other CI jobs depend on
